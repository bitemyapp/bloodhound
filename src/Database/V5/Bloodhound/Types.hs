...
{-| 'BulkOperation' is a sum type for expressing the four kinds of bulk
    ...
    generate the id. Often, people use auto-generated identifiers when ElasticSearch is the
    only place that their data is stored. Do not let ElasticSearch be
    the only place your data is stored. It does not guarantee durability,
    and it may silently discard data. This <https://github.com/elastic/elasticsearch/issues/10708 issue> is
