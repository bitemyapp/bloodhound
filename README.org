...
Current versions we test against is 1.0.3, 1.1.2, 1.2.3, and 1.3.2. We also check that GHC 7.6 and 7.8 both build. See our [TravisCI](https://travis-ci.org/bitemyapp/bloodhound) to learn more.
